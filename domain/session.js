export function resolveNextSetPosition(exercises, exerciseIndex, setIndex) {
    if (!exercises.length) {
...
export function buildSessionSnapshot(params) {
    ...
    const validCompletedSets = new Set(params.completedSets.filter((completedSet) => {
...
export function describeWorkoutState(snapshot) {
