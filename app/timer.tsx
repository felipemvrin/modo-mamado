...
const styles = StyleSheet.create({
  ...
  title: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 38, marginTop: -10 },
  ...
  presetText: { color: colors.muted, fontFamily: 'Quantico', fontWeight: '700', fontSize: 16 },
  ...
  customInput: { minHeight: 56, textAlign: 'center', color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 22, borderWidth: 1, borderColor: colors.border, borderRadius: radius.sm },
  ...
  restTitle: { color: colors.lime, fontFamily: 'Quantico', fontWeight: '700', fontSize: 63, textAlign: 'center', marginVertical: spacing.md },
  ...
  secondaryText: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13 },
  ...
  startText: { color: colors.background, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13 },
});
