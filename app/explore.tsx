...
const styles = StyleSheet.create({
  ...
  title: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 34, marginTop: -8 },
  ...
  resultsCount: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13 },
  ...
  cardName: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13 },
  ...
  modalTitle: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 22, textAlign: 'center' },
  modalMeta: { color: colors.muted, fontFamily: 'Quantico', fontSize: 11, textAlign: 'center' },
  modalPrescription: { color: colors.lime, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13, textAlign: 'center', marginTop: spacing.xs },
  ...
  modalOptionName: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13 },
