  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.list}>{exercises.map((item, index) => {
      ...
      return <View key={original.id} style={styles.exercise}>
        <View style={styles.thumbnail}>{item.mediaUrl ? <Image source={{ uri: item.mediaUrl }} style={styles.thumbnailImage} /> : <MaterialCommunityIcons name="image-off-outline" size={20} color={colors.muted} />}</View>
