...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: colors.background }, container: { padding: spacing.lg, gap: spacing.lg }, back: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, backText: { color: colors.text, fontFamily: 'Quantico', fontSize: 12 }, kicker: { color: colors.lime, fontFamily: 'Quantico', fontSize: 12, letterSpacing: 1 }, title: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 38, marginTop: -10 }, subtitle: { color: colors.muted, ...typography.body, marginTop: -10 }, list: { gap: spacing.sm }, exercise: { minHeight: 92, backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: radius.sm, padding: spacing.md, flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, thumbnail: { width: 44, height: 44, borderRadius: radius.sm, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, justifyContent: 'center', alignItems: 'center', overflow: 'hidden' }, thumbnailImage: { width: '100%', height: '100%' }, number: { width: 34, height: 34, backgroundColor: colors.limeDim, justifyContent: 'center', alignItems: 'center' }, numberText: { color: colors.lime, fontFamily: 'Quantico', fontWeight: '700' }, info: { flex: 1, gap: 6 }, name: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 16 }, detail: { color: colors.muted, fontFamily: 'Quantico', fontSize: 9 }, prescription: { alignItems: 'flex-end' }, sets: { color: colors.lime, fontFamily: 'Quantico', fontWeight: '700', fontSize: 25 }, reps: { color: colors.muted, fontFamily: 'Quantico', fontSize: 8, textAlign: 'right' }, swap: { paddingLeft: spacing.xs }, note: { flexDirection: 'row', gap: spacing.sm, alignItems: 'center', padding: spacing.md, backgroundColor: colors.surface }, noteText: { flex: 1, color: colors.muted, fontSize: 13 }, start: { minHeight: 60, backgroundColor: colors.lime, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: spacing.sm, borderRadius: radius.sm }, startDisabled: { opacity: 0.4 }, startText: { color: colors.background, fontFamily: 'Quantico', fontWeight: '700', fontSize: 13 }, modalBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' }, modalCard: { maxHeight: '70%', backgroundColor: colors.card, borderTopLeftRadius: radius.lg, borderTopRightRadius: radius.lg, padding: spacing.lg, gap: spacing.sm }, modalTitle: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 16 }, modalEmpty: { color: colors.muted, fontFamily: 'Quantico', fontSize: 12 }, modalOption: { paddingVertical: spacing.sm, borderBottomColor: colors.border, borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, modalOptionName: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 14 }, modalOptionDetail: { color: colors.muted, fontFamily: 'Quantico', fontSize: 10 }, modalReset: { marginTop: spacing.sm, alignItems: 'center', paddingVertical: spacing.sm }, modalResetText: { color: colors.error, fontFamily: 'Quantico', fontSize: 12 }, deleteAction: { width: 88, height: '100%', backgroundColor: colors.error, justifyContent: 'center', alignItems: 'center', gap: 4, borderRadius: radius.sm }, deleteActionText: { color: colors.background, fontFamily: 'Quantico', fontWeight: '700', fontSize: 10 }, restore: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs, alignSelf: 'flex-start' }, restoreText: { color: colors.lime, fontFamily: 'Quantico', fontSize: 11 }, emptyText: { color: colors.muted, fontFamily: 'Quantico', fontSize: 12, textAlign: 'center' }, zoomBackdrop: { flex: 1, backgroundColor: 'rgba(0,0,0,0.92)', justifyContent: 'center', alignItems: 'center', padding: spacing.lg }, zoomContent: { width: '100%', alignItems: 'center', gap: spacing.md }, zoomImage: { width: '100%', height: '70%' }, zoomName: { color: colors.text, fontFamily: 'Quantico', fontWeight: '700', fontSize: 18, textAlign: 'center' }, zoomClose: { position: 'absolute', top: spacing.xl, right: spacing.lg, padding: spacing.sm } });