...
export const routines: Record<MuscleGroup, Exercise[]> = {
  Pecho: [
    ...
    exercise('decline-db-press', 'Press declinado', 'Pecho', 'Mancuernas', 4, '8-12', { category: 'Pesas libres', secondaryMuscles: ['Tríceps'], difficulty: 'Intermedio', restSeconds: 90, mediaId: 'decline-db-press' }),
    exercise('db-pullover', 'Pullover', 'Pecho', 'Mancuernas', 3, '10-12', { category: 'Pesas libres', secondaryMuscles: ['Espalda', 'Tríceps'], difficulty: 'Intermedio', restSeconds: 90, mediaId: 'dumbbell-pullover' }),
    exercise('chest-dip', 'Fondos para pecho', 'Pecho', 'Barra paralela', 3, '8-10', { category: 'Calistenia', secondaryMuscles: ['Tríceps', 'Hombros'], difficulty: 'Avanzado', restSeconds: 90, mediaId: 'chest-dip' }),
    exercise('incline-barbell-press', 'Press inclinado con barra', 'Pecho', 'Barra', 4, '8-10', { category: 'Pesas libres', secondaryMuscles: ['Hombros', 'Tríceps'], difficulty: 'Intermedio', restSeconds: 90, mediaId: 'incline-barbell-press' }),
    exercise('svend-press', 'Press Svend', 'Pecho', 'Mancuernas', 3, '12-15', { category: 'Pesas libres', restSeconds: 60 }),
    exercise('low-cable-fly', 'Aperturas bajas en polea', 'Pecho', 'Polea', 3, '12-15', { category: 'Máquinas', secondaryMuscles: ['Hombros'], restSeconds: 60, mediaId: 'cable-low-fly' }),
  ],
  Espalda: [
    ...
    exercise('hyperextension', 'Hiperextensiones', 'Espalda', 'Peso corporal', 3, '12-15', { category: 'Calistenia', secondaryMuscles: ['Piernas'], restSeconds: 60, mediaId: 'hyperextension' }),
    exercise('band-row', 'Remo con banda', 'Espalda', 'Bandas', 3, '12-15', { category: 'Bandas', secondaryMuscles: ['Bíceps'], restSeconds: 60 }),
  ],
  Bíceps: [
    ...
    exercise('spider-curl', 'Curl araña', 'Bíceps', 'Mancuernas', 3, '10-12', { category: 'Pesas libres', difficulty: 'Intermedio', restSeconds: 60 }),
    exercise('high-cable-curl', 'Curl alto en polea', 'Bíceps', 'Polea', 3, '12-15', { category: 'Máquinas', restSeconds: 60, mediaId: 'high-cable-curl' }),
    exercise('reverse-curl', 'Curl invertido', 'Bíceps', 'Barra', 3, '10-12', { category: 'Pesas libres', restSeconds: 60, mediaId: 'reverse-barbell-curl' }),
  ],
  Tríceps: [
    ...
    exercise('overhead-db-extension', 'Extensión copa', 'Tríceps', 'Mancuernas', 4, '10-12', { category: 'Pesas libres', restSeconds: 60, mediaId: 'overhead-db-triceps-extension' }),
    exercise('rope-pushdown', 'Extensión con cuerda', 'Tríceps', 'Polea', 4, '12-15', { category: 'Máquinas', restSeconds: 60, mediaId: 'rope-pushdown' }),
    ...
    exercise('kickback', 'Patada de tríceps', 'Tríceps', 'Mancuernas', 3, '12-15', { category: 'Pesas libres', restSeconds: 60, mediaId: 'db-kickback' }),
    exercise('overhead-cable-extension', 'Extensión en polea alta', 'Tríceps', 'Polea', 3, '12-15', { category: 'Máquinas', restSeconds: 60, mediaId: 'overhead-cable-extension' }),
    exercise('diamond-pushup', 'Flexiones diamante', 'Tríceps', 'Peso corporal', 3, '8-12', { category: 'Calistenia', secondaryMuscles: ['Pecho'], difficulty: 'Intermedio', restSeconds: 60, mediaId: 'diamond-push-up' }),
  ],
  Hombros: [
    ...
    exercise('arnold-press', 'Press Arnold', 'Hombros', 'Mancuernas', 4, '8-12', { category: 'Pesas libres', secondaryMuscles: ['Tríceps'], difficulty: 'Intermedio', restSeconds: 90, mediaId: 'arnold-press' }),
    ...
    exercise('front-raise', 'Elevación frontal con mancuernas', 'Hombros', 'Mancuernas', 3, '12-15', { category: 'Pesas libres', restSeconds: 60, mediaId: 'front-raise' }),
    ...
    exercise('reverse-pec-deck', 'Cruces posteriores en máquina', 'Hombros', 'Máquina', 3, '12-15', { category: 'Máquinas', secondaryMuscles: ['Espalda'], restSeconds: 60, mediaId: 'reverse-pec-deck' }),
  ],
  Piernas: [
    ...
    exercise('calf-raise', 'Elevación de talones', 'Piernas', 'Máquina', 4, '15-20', { category: 'Máquinas', restSeconds: 60, mediaId: 'calf-raise' }),
  ...
  Core: [
    ...
    exercise('side-plank', 'Plancha lateral', 'Core', 'Peso corporal', 3, '30-45 seg', { category: 'Peso corporal', restSeconds: 60, mediaId: 'side-plank' }),
    ...
    exercise('woodchopper', 'Leñador en polea', 'Core', 'Polea', 3, '12-15', { category: 'Máquinas', secondaryMuscles: ['Hombros'], restSeconds: 60, mediaId: 'woodchopper' }),
